...
(def lib-name 'com.github.chunsen-w/clj-dev-reload) ; library name
...
(defn pom-data [opt]
  [[:url "https://github.com/chunsen-w/clj-dev-reload"]
   [:licenses
    [:license
     [:name "Apache-2.0"]
   ...
   [:scm
    [:url "https://github.com/chunsen-w/clj-dev-reload"]
    [:connection "scm:git:https://github.com:chunsen-w/clj-dev-reload.git"]
    [:developerConnection "scm:git:ssh:git@github.com:chunsen-w/clj-dev-reload.git"]
...
(defn jar [opt]
  ...
  (b/compile-clj {:basis     basis               ; compile clojure code
                  ...
                  :filter-nses ['com.github.clojure.dev-reload]})
